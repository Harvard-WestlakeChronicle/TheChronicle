...
<?php	
	...
	<div class="bigred pop">
		<h4 class="usatoday uppercase">Big Red <?= get_option("current_issue_year") ?></h4>
		<div class="annoyingbar"></div>
	...
	<div class="about-archives pop">
		...
		<div class="leftpart sans-serif1">
			The Chronicle launched its current website in September 2012.  Online articles starting in September 2006 are available through the search function to the right.  Digitized copies of our print editions since 2008 are available above.  Send requests for articles before 2006 to chronicle@hw.com
		</div>
		<div class='rightpart'>
