<?php
	include('jimbrink/class.tribute.php');
	function mypath(){
...
<head>
	...
	<title>Jim Brink - In Memoriam</title>
	<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,700,300,600' rel='stylesheet' type='text/css'>
	<link rel="shortcut icon" href="<?php bloginfo('template_directory'); ?>/jimbrink/img/candle.png">
	<link href="<?php bloginfo('template_directory'); ?>/jimbrink/css/style.css" rel="stylesheet" >
	<link href="<?php bloginfo('template_directory'); ?>/jimbrink/css/reveal.css" rel="stylesheet" >

	<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.6.0/jquery.min.js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/js/jquery.easing.1.3.js"></script>	
	<script src="<?php echo get_template_directory_uri(); ?>/jimbrink/js/jquery.leanModal.min.js"></script>	
	<script src="<?php echo get_template_directory_uri(); ?>/jimbrink/js/jquery.reveal.js"></script>	
	<script src="<?php echo get_template_directory_uri(); ?>/jimbrink/js/jquery.form.js"></script>	
	<script src="<?php echo get_template_directory_uri(); ?>/jimbrink/js/placeholders.min.js"></script>	
...
<div id="toppart">
	<div class="inner">
		<div class="left">
			<img src="<?php bloginfo('template_directory'); ?>/jimbrink/img/Jim.JPG" />
		</div>
		<div class="right">
...
<header>
	<div class="inner">
		...
		<img src="<?php bloginfo('template_directory'); ?>/jimbrink/img/heart@2x.png" />
...
<div id="myoverlay">
	<div class="upper">Share a memory of Jim</div>
	<div class="lower">
		...
		<div id="uploadimagesection">
			<h3>Add an image</h3>
			<form id="imageform" method="post" enctype="multipart/form-data" action='<?php mypath(); ?>/jimbrink/requestuploadimage.php'>
				<input type="file" name="photoimg" id="photoimg" />
				<img src="<?php mypath(); ?>/jimbrink/img/loading.gif" id="loadingupload" />
				<img src="<?php mypath(); ?>/jimbrink/img/check.png" id="checkupload" />
			</form>
		</div>
...
$("a#done").click(function(e){
	...
	if(image){
		image = $('<img/>').attr('src', '<?php mypath(); ?>/jimbrink/img/uploads/'+image).addClass('imageattachment');
...
$("#submit").click(function(){
	var url = "<?php mypath(); ?>/jimbrink/submitmessage.php";
	var name = $('#namefield').val();
	var email = $('#emailfield').val();
	var message = $('#messagefield').val();
	var anon = 0;
