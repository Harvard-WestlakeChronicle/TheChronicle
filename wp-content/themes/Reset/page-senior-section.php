	...
	<body>
		...
		<div class="years">
			<div>
				...
				<div id="nine" class="year" >
					<div class="title">
						Nine
					</div>
					<div class="thumb">
						<img height="320" width="240" src="<?php bloginfo('template_directory') ?>/feature/senior_section/images/fridaynight.jpg">
					</div>
					<div class="text">
			...
			<div>
				<div id="ten" class="year first" >
					<div class="title">
						Ten
					</div>
					<div class="thumb">
						<img height="320" width="240" src="<?php bloginfo('template_directory') ?>/feature/senior_section/images/oitnb.jpg">
					</div>
					<div class="text">
				...
				<div id="eleven" class="year" >
					<div class="title">
						Eleven
					</div>
					<div class="thumb">
						<img height="320" width="240" src="<?php bloginfo('template_directory') ?>/feature/senior_section/images/houseofcards.jpg">
					</div>
					<div class="text">
				...
				<div id="twelve" class="year" >
					<div class="title">
						Twelve
					</div>
					<div class="thumb">
						<img height="320" width="240" src="<?php bloginfo('template_directory') ?>/feature/senior_section/images/friends.jpg">
					</div>
					<div class="text">
