			...
			<div class="inner">
				...
				<div id="big-header-rightstuff">
					...
					<div id="big-header-day">
						...
						<div class="two">						
							<a target="_blank" title="about" href="<?php echo site_url(); ?>/about/"><img src="<?php echo get_template_directory_uri(); ?>/images/newminicrest.png" /></a>
							<p class="three">THE ONLINE STUDENT NEWSPAPER <br/>OF HARVARD-WESTLAKE SCHOOL <br/>LOS ANGELES, CALIFORNIA</p>
						</div>
					</div>
				</div>
			</div>
