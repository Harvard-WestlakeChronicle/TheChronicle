		...
		<div id="content">
			...
			<div id="third" class="death">
				<div class="left">
					...
					<h4 class="two"><a href="http://www.hwchronicle.com/opinion/get-in-touch-get-involved/">Letter from the Editors</a></h4>
...
*/
		...
		$('h4.two').hover(function(){
			$('#switch').attr('src', '<?php echo get_template_directory_uri(); ?>/images/eicsmall.jpg');
		});
