...
Originally designed by David Lim and Austin Chan.
...
?>
	...
	<![endif]-->
	<?php if(is_post_type_archive('video')||get_post_type() === 'video'){ ?>
...
<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/iconfont/css/font-awesome.min.css"/>
	...
	<script src="<?php echo get_template_directory_uri(); ?>/js/jquery.livequery.min.js"></script>	
