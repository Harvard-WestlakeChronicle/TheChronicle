...
?>
		...
		</div><?php }else{echo '<style>.entry-content{height:480px !important;}.related-title{width:135px !important;}iframe{margin-top:19px;}</style>';}?>
		<div class="clear"></div>
		<div class="video-bottom tint pop inner">
			...
			<?php if($youtubeplaylist){ ?>
			<div class="clear"></div>
			<div class="related-videos tint pop" style="height:auto;min-height:243px;width:295px;">
			<h4>Related Videos</h4>
			<?php get_related_videos(); ?>
		</div>
		<div id="comments" class="pop tint">
