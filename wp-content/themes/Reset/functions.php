...
$wp_template_css['style']( null, $wp_template_css['html'] );
...
function my_user_contactmethods($user_contactmethods){  
  ...
  $user_contactmethods['currentPosition'] = 'Your Position';
  $user_contactmethods['currentSection'] = 'Your Section';
...
/* 	Hide posts */
	...
	function register_taxonomy_other_publication() {
	    ...
	    $labels = array( 
	        'name' => _x( 'Is from other publication (not Chronicle)?', 'other publication' ),
	        'singular_name' => _x( 'Is from other publication (not Chronicle)?', 'other publication' ),
	        'search_items' => _x( 'Search Is from other publication (not Chronicle)?', 'other publication' ),
	        'popular_items' => _x( 'Popular Is from other publication (not Chronicle)?', 'other publication' ),
	        'all_items' => _x( 'All Is from other publication (not Chronicle)?', 'other publication' ),
	        'parent_item' => _x( 'Parent Is from other publication (not Chronicle)?', 'other publication' ),
	        'parent_item_colon' => _x( 'Parent Is from other publication (not Chronicle)?:', 'other publication' ),
	        'edit_item' => _x( 'Edit Is from other publication (not Chronicle)?', 'other publication' ),
	        'update_item' => _x( 'Update Is from other publication (not Chronicle)?', 'other publication' ),
	        'add_new_item' => _x( 'Add New Is from other publication (not Chronicle)?', 'other publication' ),
	        'new_item_name' => _x( 'New Is from other publication (not Chronicle)?', 'other publication' ),
	        'separate_items_with_commas' => _x( 'Separate Is from other publication (not Chronicle)? with commas', 'other publication' ),
	        'add_or_remove_items' => _x( 'Add or remove Is from other publication (not Chronicle)?', 'other publication' ),
	        'choose_from_most_used' => _x( 'Choose from most used Is from other publication (not Chronicle)?', 'other publication' ),
	        'menu_name' => _x( 'Is from other publication (not Chronicle)?', 'other publication' ),
	    );
	...
	function register_taxonomy_old_issue() {
	    ...
	    $labels = array( 
	        'name' => _x( 'Issue is from the old site?', 'old site' ),
	        'singular_name' => _x( 'Issue is from the old site?', 'old site' ),
	        'search_items' => _x( 'Search Issue is from the old site?', 'old site' ),
	        'popular_items' => _x( 'Popular Issue is from the old site?', 'old site' ),
	        'all_items' => _x( 'All Issue is from the old site?', 'old site' ),
	        'parent_item' => _x( 'Parent Issue is from the old site?', 'old site' ),
	        'parent_item_colon' => _x( 'Parent Issue is from the old site?:', 'old site' ),
	        'edit_item' => _x( 'Edit Issue is from the old site?', 'old site' ),
	        'update_item' => _x( 'Update Issue is from the old site?', 'old site' ),
	        'add_new_item' => _x( 'Add New Issue is from the old site?', 'old site' ),
	        'new_item_name' => _x( 'New Issue is from the old site?', 'old site' ),
	        'separate_items_with_commas' => _x( 'Separate issue is from the old site? with commas', 'old site' ),
	        'add_or_remove_items' => _x( 'Add or remove Issue is from the old site?', 'old site' ),
	        'choose_from_most_used' => _x( 'Choose from most used Issue is from the old site?', 'old site' ),
	        'menu_name' => _x( 'Issue is from the old site?', 'old site' ),
	    );
	...
	function register_taxonomy_sports_type() {
	    ...
	    $labels = array( 
	        'name' => _x( 'Sports Type', 'sports type' ),
...
// A&E Importance --------------------------------------------------
    ...
    add_action( 'init', 'register_taxonomy_ae_importance' );
	function register_taxonomy_ae_importance() {
	
	    $labels = array( 
	        'name' => _x( 'A&E Importance (optional)', 'ae importance' ),
	        'singular_name' => _x( 'A&E Importance', 'ae importance' ),
	        'search_items' => _x( 'Search A&E Importance', 'ae importance' ),
	        'popular_items' => _x( 'Popular A&E Importance', 'ae importance' ),
	        'all_items' => _x( 'All A&E Importance', 'ae importance' ),
	        'parent_item' => _x( 'Parent A&E Importance', 'ae importance' ),
	        'parent_item_colon' => _x( 'Parent A&E Importance:', 'ae importance' ),
	        'edit_item' => _x( 'Edit A&E Importance', 'ae importance' ),
	        'update_item' => _x( 'Update A&E Importance', 'ae importance' ),
	        'add_new_item' => _x( 'Add New A&E Importance', 'ae importance' ),
	        'new_item_name' => _x( 'New A&E Importance', 'ae importance' ),
	        'separate_items_with_commas' => _x( 'Separate ae importance with commas', 'ae importance' ),
	        'add_or_remove_items' => _x( 'Add or remove A&E Importance', 'ae importance' ),
	        'choose_from_most_used' => _x( 'Choose from most used A&E Importance', 'ae importance' ),
	        'menu_name' => _x( 'A&E Importance', 'ae importance' ),
	    );
	    ...
	    register_taxonomy( 'ae_importance', 'ae', $args );
    }
    
// A&E Type --------------------------------------------------
	
    add_action( 'init', 'register_taxonomy_ae_type' );
	function register_taxonomy_ae_type() {
	
	    $labels = array( 
	        'name' => _x( 'A&E Type', 'ae type' ),
	        'singular_name' => _x( 'A&E Type', 'ae type' ),
	        'search_items' => _x( 'Search A&E Type', 'ae type' ),
	        'popular_items' => _x( 'Popular A&E Type', 'ae type' ),
	        'all_items' => _x( 'All A&E Type', 'ae type' ),
	        'parent_item' => _x( 'Parent A&E Type', 'ae type' ),
	        'parent_item_colon' => _x( 'Parent A&E Type:', 'ae type' ),
	        'edit_item' => _x( 'Edit A&E Type', 'ae type' ),
	        'update_item' => _x( 'Update A&E Type', 'ae type' ),
	        'add_new_item' => _x( 'Add New A&E Type', 'ae type' ),
	        'new_item_name' => _x( 'New A&E Type', 'ae type' ),
	        'separate_items_with_commas' => _x( 'Separate ae type with commas', 'ae type' ),
	        'add_or_remove_items' => _x( 'Add or remove A&E Type', 'ae type' ),
	        'choose_from_most_used' => _x( 'Choose from most used A&E Type', 'ae type' ),
	        'menu_name' => _x( 'A&E Type', 'ae type' ),
	    );
	    ...
	    register_taxonomy( 'ae_type', 'ae', $args );
    }
...
add_filter( 'admin_post_thumbnail_html', 'custom_admin_post_thumbnail_html' );
	...
	function add_special_label() {
		$types = array('news', 'sports', 'opinion', 'features', 'photo', 'ae', 'video', 'broadcast');
		foreach($types as $type){
...
*/
	...
	// You don't wanna know.  I don't either.  No one ever appreciates me.  It's 2am in the morning. I'm so lonely <-ACHAN
...
<?php
	...
	function facebook_code_6($width = 650, $colorscheme = 'dark'){
	?>
		<div class="fb-comments" data-href="<?php echo current_url(); ?>" data-num-posts="5" data-width="<?=$width; ?>" data-colorscheme="<?=$colorscheme; ?>"></div>
	<?php
	}
...
<?php
	...
	function alter_author_wpse_84696() {
      ...
      $wp_query->set('post_type', array('news', 'sports', 'opinion', 'features', 'ae', 'video', 'photo', 'broadcast'));
    }
    add_action('pre_get_posts','alter_author_wpse_84696');
    
    function alter_video_wpse_84696($query) {
      global $is_json;
      if ($query->is_post_type_archive('video') && !$is_json)
          $query->set('posts_per_page', 12);
    }
    add_action('pre_get_posts','alter_video_wpse_84696');
    
    function alter_photo_wpse_84696($query){
    	global $is_json;
        if ($query->is_post_type_archive('photo') && !$is_json){
            $query->set('posts_per_page', 9);
        }
    }
    add_action('pre_get_posts','alter_photo_wpse_84696');
	...
	function MainFunction_Init() {
		wp_add_dashboard_widget( 'MainFunction', __( 'Sports Season' ), 'MainFunction', 'MainFunction_Setup' );
	}
	
	function ReturnWidget(){
		$widget_options = MainFunction_Options();
		return $widget_options['season'];
	}
	 $season = ReturnWidget();
	 
	function MainFunction_Options() {
		$defaults = array( 'season' => 'Fall');
	...
	?>
	 		...
	 		<p>
			<label for="season">
	<select id="season" name="season" class="widefat">
					<?PHP
						$optionss = array('Fall', 'Winter', 'Spring');
						foreach ($optionss as $option)
							echo "<option value='$option'" . ( $options['season'] == $option ? " selected='selected'" : '' ) . ">$option</option>";
					?>
				</select>
	...
	function opinionWidget() {
	      $widget_options = opinionWidgetFunction_Options();
	 
		echo 'Hit configure to switch between showing blogs or letters to the editor on opinion, and how many^<br />';
		echo "You have selected {$widget_options['blogamount']} blog post(s)<br />";
		echo "You have selected {$widget_options['letteramount']} letter post(s)<br />";
		echo "You have selected {$widget_options['guestamount']} guest post(s)<br />";
		
	}
	 
	function opinionWidget_Init() {
		wp_add_dashboard_widget( 'opinionWidget', __( 'Type' ), 'opinionWidget', 'opinionWidget_Setup' );
	}
	
	function ReturnblogWidgetAmount(){
		$widget_options = opinionWidgetFunction_Options();
		return $widget_options['blogamount'];
	}
	function ReturnletterWidgetAmount(){
		$widget_options = opinionWidgetFunction_Options();
		return $widget_options['letteramount'];
	}
	function ReturnguestWidgetAmount(){
		$widget_options = opinionWidgetFunction_Options();
		return $widget_options['guestamount'];
	}
	
	$blogamount = ReturnopinionWidgetAmount();
	$letteramount = ReturnletterWidgetAmount();
	$guestamount = ReturnguestWidgetAmount();
	
	function opinionWidgetFunction_Options() {
		$defaults = array( 'blogamount' => 1, 'letteramount' => 1, 'guestamount' => 1);
		if ( ( !$options = get_option( 'opinionWidget' ) ) || !is_array($options) )
			$options = array();
		return array_merge( $defaults, $options );
	}
	 
	function opinionWidget_Setup() {
	 
		$options = opinionWidgetFunction_Options();
	 
		if ( 'post' == strtolower($_SERVER['REQUEST_METHOD']) && isset( $_POST['widget_id'] ) && 'opinionWidget' == $_POST['widget_id'] ) {
			foreach ( array( 'blogamount', 'letteramount','guestamount') as $key )
					$options[$key] = $_POST[$key];
			update_option( 'opinionWidget', $options );
		}
	...
	?>
	 		...
	 		<p>
			<p>Blog Amount:</p>
			<label for="blogamount">
	<select id="blogamount" name="blogamount" class="widefat">
					<?PHP
						$option3 = array(0,1,2,3,4,5,6);
						foreach ($option3 as $option)
							echo "<option value='$option'" . ( $options['blogamount'] == $option ? " selected='selected'" : '' ) . ">$option</option>";
					?>
				</select>
	 
			</label>
			<p>Letter Amount:</p>
			<label for="letteramount">
	<select id="letteramount" name="letteramount" class="widefat">
					<?PHP
						foreach ($option3 as $option)
							echo "<option value='$option'" . ( $options['letteramount'] == $option ? " selected='selected'" : '' ) . ">$option</option>";
					?>
				</select>
	 
			</label>
			<p>Guest Column Amount:</p>
			<label for="guestamount">
	<select id="guestamount" name="guestamount" class="widefat">
					<?PHP
						foreach ($option3 as $option)
							echo "<option value='$option'" . ( $options['guestamount'] == $option ? " selected='selected'" : '' ) . ">$option</option>";
					?>
				</select>
	...
	add_action('wp_dashboard_setup', 'opinionWidget_Init');*/
?>