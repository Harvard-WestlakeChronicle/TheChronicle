...
<header id="snubbed-header" class="pop inner news">
	...
	<div id="SingleTop">
		...
		<p class="left uppercase one latest">Latest News Headlines</p>
		<div class="screams left">
	
		<?php
			global $post;
			$query = new WP_Query(array( 'post_type' => 'news', 'posts_per_page' => 3, "post__not_in" => array($post->ID)) );
			$count = 0;
